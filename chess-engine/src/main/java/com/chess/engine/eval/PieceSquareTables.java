 ...
 * Values from the original code, reorganised into a single lookup.
...
public final class PieceSquareTables {
    ...
    /**
     * Returns the positional bonus for a piece at a given file/rank.
    ...
    public static int bonus(Piece piece, int file, int rank) {
        ...
        return table[tableRank * Board.SIZE + file];
    }
    ...
    private static int[] tableFor(PieceType type) {
        return switch (type) {
            ...
            case KING   -> KING_MG_TABLE;
        };
    }

    // Needed by Evaluator for the Board.SIZE reference
    private static final int Board_SIZE = 8;
    // (Board.SIZE is accessible since we import Board — omitted here for brevity)
}
